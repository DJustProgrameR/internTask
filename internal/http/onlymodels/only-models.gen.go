...
// GetFilteredResponse defines model for GetFilteredResponse.
type GetFilteredResponse = []struct {
	Pvz        *PVZ                           `json:"pvz,omitempty"`
	Receptions *GetFilteredResponseReceptions `json:"receptions,omitempty"`
}

// GetFilteredResponseReceptions defines model for GetFilteredResponseReceptions.
type GetFilteredResponseReceptions = []struct {
